...
import 'ai_processing_result.dart' as _i4;
...
import 'reminder.dart' as _i9;
import 'search_query.dart' as _i10;
import 'search_request.dart' as _i11;
import 'search_result.dart' as _i12;
import 'user_preference.dart' as _i13;
import 'weekly_digest.dart' as _i14;
import 'package:recall_butler_server/src/generated/capture.dart' as _i15;
import 'package:recall_butler_server/src/generated/collection.dart' as _i16;
...
class Protocol extends _i1.SerializationManagerServer {
  ...
  T deserialize<T>(
    ...
    if (t == _i4.AIProcessingResult) {
      return _i4.AIProcessingResult.fromJson(data) as T;
    }
    if (t == _i5.Capture) {
    ...
    if (t == _i11.SearchRequest) {
      return _i11.SearchRequest.fromJson(data) as T;
    }
    ...
    if (t == _i14.WeeklyDigest) {
      return _i14.WeeklyDigest.fromJson(data) as T;
    }
    if (t == _i1.getType<_i3.Greeting?>()) {
      return (data != null ? _i3.Greeting.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i4.AIProcessingResult?>()) {
      return (data != null ? _i4.AIProcessingResult.fromJson(data) : null) as T;
    }
    ...
    if (t == _i1.getType<_i11.SearchRequest?>()) {
      return (data != null ? _i11.SearchRequest.fromJson(data) : null) as T;
    }
    ...
    if (t == _i1.getType<_i14.WeeklyDigest?>()) {
      return (data != null ? _i14.WeeklyDigest.fromJson(data) : null) as T;
    }
    if (t == List<String>) {
    ...
    if (t == List<_i15.Capture>) {
      return (data as List).map((e) => deserialize<_i15.Capture>(e)).toList()
          as T;
    }
    if (t == List<_i16.Collection>) {
      return (data as List).map((e) => deserialize<_i16.Collection>(e)).toList()
          as T;
    }
  ...
  String? getClassNameForObject(Object? data) {
    ...
    if (data is _i4.AIProcessingResult) {
    ...
    if (data is _i9.Reminder) {
      return 'Reminder';
    }
    if (data is _i10.SearchQuery) {
      return 'SearchQuery';
    }
    if (data is _i11.SearchRequest) {
      return 'SearchRequest';
    }
    if (data is _i12.SearchResult) {
      return 'SearchResult';
    }
    if (data is _i13.UserPreference) {
      return 'UserPreference';
    }
    if (data is _i14.WeeklyDigest) {
      return 'WeeklyDigest';
    }
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (dataClassName == 'AIProcessingResult') {
      return deserialize<_i4.AIProcessingResult>(data['data']);
    }
    ...
    if (dataClassName == 'SearchRequest') {
      return deserialize<_i11.SearchRequest>(data['data']);
    }
    ...
    if (dataClassName == 'WeeklyDigest') {
      return deserialize<_i14.WeeklyDigest>(data['data']);
    }
  ...
  _i1.Table? getTableForType(Type t) {
    ...
    switch (t) {
      case _i5.Capture:
        return _i5.Capture.t;
      case _i6.CaptureCollection:
        return _i6.CaptureCollection.t;
      case _i8.Collection:
        return _i8.Collection.t;
      case _i9.Reminder:
        return _i9.Reminder.t;
      case _i10.SearchQuery:
        return _i10.SearchQuery.t;
      case _i13.UserPreference:
        return _i13.UserPreference.t;
    }
    return null;
  }
